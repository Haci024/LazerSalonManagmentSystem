...
namespace LazerBeautyFullProject.Areas.ArzumEstetic.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        {
            List<KassaActionList> kassaActionLists = _appDbContext.KassaActionLists.Include(x => x.AppUser).Include(x => x.Filial).Where(x => x.FilialId == 3 && x.LastOutMoneyDate >= startDate && x.LastOutMoneyDate <= endDate && x.Status == true).ToList();
        ...
        {
            List<KassaActionList> kassaActionLists = _appDbContext.KassaActionLists.Include(x => x.AppUser).Include(x => x.Filial).Where(x => x.FilialId == 3 && x.LastOutMoneyDate >= startDate && x.LastOutMoneyDate <= endDate && x.Status == false).ToList();
            decimal earning = kassaActionLists.Sum(x => x.OutMoneyQuantity);
            return earning;
        }
        [HttpPost]
        public IActionResult SelectKassaActionListAddMoney(DateTime startDate, DateTime endDate)
        {
            ...
            return PartialView("~/Areas/ArzumEstetic/Views/Shared/_KassaActionList.cshtml", kassaActionLists);
        }
        public List<KassaActionList> GetKassaActionListAddMoney(DateTime startDate, DateTime endDate)
        {
            List<KassaActionList> kassaActionLists = _appDbContext.KassaActionLists.Include(x => x.Filial).Include(x => x.AppUser).Where(x => x.LastOutMoneyDate >= startDate && x.LastOutMoneyDate <= endDate && x.FilialId == 3 && x.Status == true).ToList();
        ...
        {
            List<KassaActionList> kassaActionLists = _appDbContext.KassaActionLists.Include(x => x.Filial).Include(x => x.AppUser).Where(x => x.LastOutMoneyDate >= startDate && x.LastOutMoneyDate <= endDate && x.FilialId == 3 && x.Status == false).ToList();
        ...
        public IActionResult SelectKassaActionListAllReports(DateTime startDate, DateTime endDate)
        {
            ...
            return PartialView("~/Areas/ArzumEstetic/Views/Shared/_KassaActionList.cshtml", kassaActions);
        }
        public List<KassaActionList> GetKassaActionAllReports(DateTime startDate, DateTime endDate)
        {
            List<KassaActionList> kassaActionLists = _appDbContext.KassaActionLists.Include(x => x.Filial).Include(x => x.AppUser).Where(x => x.LastOutMoneyDate >= startDate && x.LastOutMoneyDate <= endDate && x.FilialId == 3).ToList();
